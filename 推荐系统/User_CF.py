...
def evaluate_model(user_similarity, ratings_matrix, real_matrix, k):
    ...
    for i in range(test_row):
        ...
        for j in range(test_col):
            ...
            rating = predict_rating(user_similarity, ratings_matrix, user_id, item_id, k)  # 使用相似度和评分矩阵预测评分
...
if __name__ == "__main__":
    ...
    for i in range(len(k_list)):
        rmse, coverage = evaluate_model(user_similarity, ratings_matrix, real_matrix, k_list[i])
